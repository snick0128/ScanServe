...
class _MenuItemsScreenState extends State<MenuItemsScreen> {
  ...
  void _exportCsv(BuildContext context, List<MenuItem> items) {
    final header =
        'ID,Name,Category,Subcategory,Price,Type,Bestseller,Manual Availability,Stock Count\n';
    final rows = items
        .map(
          (i) =>
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Text(
                'CSV Data is ready to be exported.',
              ...
              Container(
                ...
                child: const Text(
                  'Export will download as .csv file',
                  style: TextStyle(
                    fontSize: 12,
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Menu exported to CSV successfully'),
                  ),
                );
              },
                  ...
                  children: [
                    Expanded(
                      child: _buildActionCircle(
                        Ionicons.download_outline,
                        'Export',
                        () => _exportCsv(context, provider.allItems),
                        isMobile,
                      ),
                    ),
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: provider.searchInput.isEmpty
                          ? null
                          : IconButton(
                              onPressed: () {
  ...
  Widget _buildBestsellerToggle(MenuProvider provider) {
    return FilterChip(
      ...
      labelStyle: TextStyle(
        color: provider.isBestsellerOnly
            ? AdminTheme.primaryColor
            : AdminTheme.secondaryText,
        fontWeight: FontWeight.bold,
      ),
  ...
  void _toggleAvailability(BuildContext context, MenuItem item) async {
    ...
    final cat = provider.categories.firstWhere(
      (c) => item.category != null && c.name == item.category,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 1,
            child: Row(children: [_buildDietBadge(item.isVeg)]),
          ),
          // Bestseller Toggle
          Expanded(
            flex: 1,
    ...
    return Container(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          shape: isVeg
              ? BoxShape.circle
              : BoxShape.rectangle, // Simple approximation
        ),
      ),
    );
  }
